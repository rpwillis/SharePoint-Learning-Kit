ALTER TABLE LearnerAssignmentItem ADD LearnerComments NVARCHAR(max) NULL
GO
...
SET @schema = @schema +
    ...
    '</ItemType>'
SET @schema = @schema +
    '<ItemType Name="UserItemSite" ViewFunction="UserItemSite$DefaultView">' + 
        '<Property Name="UserId" TypeCode="1" Nullable="false" HasDefault="false" ReferencedItemTypeName="UserItem"/>' +
...
ALTER FUNCTION [LearnerAssignmentList](@UserKey nvarchar(250))
RETURNS TABLE
AS
RETURN (
    SELECT
