...
gacutil /nologo /i Src\Compression\MRCI\bin\Debug\Microsoft.LearningComponents.MRCI.dll
gacutil /nologo /i Src\Compression\Compression\bin\Debug\Microsoft.LearningComponents.Compression.dll
