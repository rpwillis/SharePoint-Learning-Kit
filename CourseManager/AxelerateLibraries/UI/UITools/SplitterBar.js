...
var m_axlSplitterBars = new Array();
var _activeSplitterBar = null;
var _isIE = (document.all) ? true : false;

// define the axlSplitterBar "class"
function axlSplitterBar(splitter)
{
	this.id = splitter.id; 
...
axlSplitterBar.prototype.SetBackgroundColor = axlSplitterBar_SetBackgroundColor;
axlSplitterBar.prototype.init = axlSplitterBarSetup;
axlSplitterBar.prototype.show = axlSplitterBar_show;
axlSplitterBar.prototype.hide = axlSplitterBar_hide;
axlSplitterBar.prototype.setTargetWidth = axlSplitterBar_setTargetWidth;
axlSplitterBar.prototype.setTargetHeight = axlSplitterBar_setTargetHeight;
axlSplitterBar.prototype.drag = axlSplitterBar_drag;
axlSplitterBar.prototype.onmousedown = axlSplitterBar_onmousedown;
axlSplitterBar.prototype.onmouseup = axlSplitterBar_onmouseup;
axlSplitterBar.prototype.ondblclick = axlSplitterBar_ondblclick;
axlSplitterBar.prototype.showIFrames = axlSplitterBar_showIFrames;
axlSplitterBar.prototype.hideIFrames = axlSplitterBar_hideIFrames;

// define the "static" methods
axlSplitterBar.createNew = axlSplitterBar_createNew;
axlSplitterBar.getById = axlSplitterBar_getById;
axlSplitterBar.getCurrent = axlSplitterBar_getCurrent;
axlSplitterBar.reconfigure = axlSplitterBarreinit;
axlSplitterBar.setLiveResize = axlSplitterBar_setLiveResize;
axlSplitterBar.setDebug = axlSplitterBar_setDebug;

// create the property set for backgroundColor
function axlSplitterBar_SetBackgroundColor(value)
{
...
function axlSplitterBar_createNew(splitterId)
{
	var splitter = document.getElementById(splitterId);
	var sbar = new axlSplitterBar(splitter);
	m_axlSplitterBars[m_axlSplitterBars.length] = sbar;
	return sbar;
}

// create the getById static method
function axlSplitterBar_getById(id)
{
	var sbar = null;
	var sbarId = id; 
	for ( var i = 0; i < m_axlSplitterBars.length; i++ )
	{
		sbar = m_axlSplitterBars[i];
		if ( sbar.id == sbarId )
		{
			break;
		}
...
function axlSplitterBar_getCurrent()
{
	return _activeSplitterBar;
}

// create the reinitialize static method
function axlSplitterBarreinit()
{
	for ( var i = 0; i < m_axlSplitterBars.length; i++ )
	{
		m_axlSplitterBars[i].init();
	}	
}

// create the setLiveResize static method
function axlSplitterBar_setLiveResize(setting)
{
	for ( var i = 0; i < m_axlSplitterBars.length; i++ )
	{
		m_axlSplitterBars[i].liveResize = setting;
	}	
}

// create the setDebug static method
function axlSplitterBar_setDebug(debugId, namingContainerId)
{
	var txt = null;
	if ( debugId ) 
	{
	...
	for ( var i = 0; i < m_axlSplitterBars.length; i++ )
	{
		m_axlSplitterBars[i].debug = txt;
	}	
}
	
// create the initialize method
function axlSplitterBarSetup()
{
	...
	{
		sbar = axlSplitterBar.getById(this.id);
	}
	...
	if ( sbar )
	{
		...
		if ( splitter && target )
		{
			...
			// is happening.
			window.onresize = axlSplitterBar.reconfigure; 
		}
	}	
}

// create the show method
function axlSplitterBar_show()
{
	var sbar = axlSplitterBar.getById(this.id);
...
function axlSplitterBar_setTargetWidth(sbar)
{
	if ( sbar == null )
	{
		sbar = axlSplitterBar.getCurrent();
	}
	if ( sbar )
	{
		var width = 0;
...
function axlSplitterBar_setTargetHeight(sbar)
{
	if ( sbar == null )
	{
		sbar = axlSplitterBar.getCurrent();
...
function axlSplitterBar_drag(evnt)
{
	evnt = evnt ? evnt : event;
	if ( evnt )
	{
		var sbar = axlSplitterBar.getCurrent();
		if ( sbar && sbar.isResizing )
		{
...
function axlSplitterBar_onmousedown(evnt)
{
	var sbar = axlSplitterBar.getById(this.id);
	if ( sbar )
	{
...
function axlSplitterBar_onmouseup(evnt)
{
	var sbar = axlSplitterBar.getCurrent();
...
function axlSplitterBar_ondblclick(evnt)
{
	var splitter = this; //axlSplitterBar.getCurrent();
	var sbar = axlSplitterBar.getById(splitter.id);
...
function axlSplitterBar_hideIFrames()
{
	var sbar = this;
...
function axlSplitterBar_showIFrames()
{
	var sbar = this;
	if (sbar.iframeHiding != "DoNotHide")
	{
