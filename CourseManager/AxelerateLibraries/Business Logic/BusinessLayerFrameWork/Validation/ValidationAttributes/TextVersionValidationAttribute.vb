Namespace BLCore.Validation.ValidationAttributes
    ...
    Public Class TextVersionValidationAttribute
...
#Region "ValidationAttribute Overrides"
        Public Overrides Function Validate(ByVal target As Object, ByRef e As String) As Boolean
            ...
            If (Not Value Is Nothing) Then
                Dim IntMaxValueString As String = CStr(0)
                Dim InvalidVersionString As String = IntMaxValueString + "." + IntMaxValueString + "." + IntMaxValueString + "." + IntMaxValueString
                If (CStr(Value) = InvalidVersionString) Then
...
#Region "SinglePropertyValidationAttribute Overrides"
        Protected Overrides ReadOnly Property ValidationFailedMessage() As String
            Get
                Return My.Resources.BLResources.Validation_InvalidVersion.Replace("[PropertyName]", PropertyName)
            End Get
        End Property
#End Region
