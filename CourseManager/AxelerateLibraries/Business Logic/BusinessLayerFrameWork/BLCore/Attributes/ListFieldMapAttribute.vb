...
Namespace BLCore.Attributes
    ...
    ''' updated, inserted or deleted when one of these operations is performed on its parent object (the class that contains this field).  
    ''' The expected type for a field marked with this attribute is any type that inherits from BLListBase.
    ''' </summary>
    ''' <remarks></remarks>
    <AttributeUsage(AttributeTargets.Field)> _
    Public Class ListFieldMapAttribute
        Inherits Attribute
...
#Region "Attribute Checking"
        ...
        Private Shared AttributeType As Type = GetType(ListFieldMapAttribute)
        ...
        Public Overloads Shared Function GetAttribute(ByVal Field As FieldInfo) As ListFieldMapAttribute
            Return CType(Attribute.GetCustomAttribute(Field, AttributeType), ListFieldMapAttribute)
        End Function
