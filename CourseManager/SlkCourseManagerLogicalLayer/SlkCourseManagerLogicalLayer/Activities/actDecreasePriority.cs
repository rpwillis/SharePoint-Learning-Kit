...
{
    class actDecreasePriority : BLBusinessActivity
    {
        ...
        public override void BLExecuteCommand()
        {
            ...
            {
                throw new Exception("Failed reducing activity group priority", e);
            }
        }
        ...
        public override void Test()
        {
            ...
            {
                throw new Exception("Activity group priority was not reduced correctly.");
            }
        }
        #endregion
    }
