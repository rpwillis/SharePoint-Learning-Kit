...
namespace Microsoft.LearningComponents
{
    ...
    */
    ...
    internal class PlainTextString 
    {
        /// <summary>
        ...
        internal PlainTextString(string plainText)
        {
    ...
    */
    ...
    internal class HtmlString // see TODO#1 above
    {
        /// <summary>
        /// The string value wrapped by this class.
        /// </summary>
        ...
        internal HtmlString(string html)
        {
            m_html = html;
        }
        ...
        /// </remarks>
        internal HtmlString(PlainTextString plainText)
        {
    ...
    */
    ...
    internal class JScriptString 
    {
        ...
        internal JScriptString(string jscript)
        {
            m_jscript = jscript;
        }

        internal static JScriptString QuoteString(string plainText)
        {
            return QuoteString(plainText, false);
        }

        internal static JScriptString QuoteString(string plainText, bool singleQuote)
        {
            if (singleQuote)
    ...
    */
    ...
    internal class UrlString 
    {
        ...
        internal UrlString(string url)
        {
            m_url = url;
        }

        internal UrlString(Uri uri)
        {
        ...
        internal UrlString ToAscii()
        {
            ...
            // done
            return new UrlString(ascii.ToString());
        }
    ...
    */
    internal class HtmlStringWriter : IDisposable// see TODO#1 above
    {
        /// <summary>
        ...
        internal HtmlStringWriter(int capacity)
        {
        ...
        internal HtmlStringWriter(int capacity, string tabString)
        {
            StringBuilder sb = new StringBuilder(capacity);
            StringWriter sw = new StringWriter(sb, CultureInfo.InvariantCulture);
            m_htmlTextWriter = new HtmlTextWriter(sw, tabString);
        }

        internal HtmlStringWriter(TextWriter writer)
        {
            m_htmlTextWriter = new HtmlTextWriter(writer);
        }

        internal HtmlStringWriter(HtmlTextWriter writer)
        {
            m_htmlTextWriter = writer;
        }

        internal HtmlStringWriter(TextWriter writer, string tabString)
        {
            m_htmlTextWriter = new HtmlTextWriter(writer, tabString);
        }

        internal void AddAttribute(string name, PlainTextString plainText)
        {
            m_htmlTextWriter.AddAttribute(name, plainText);
        }

        internal void AddAttribute(HtmlTextWriterAttribute key,
        ...
        internal void AddJavascriptProtocolAttribute(string name,
        ...
        internal void AddJavascriptProtocolAttribute(HtmlTextWriterAttribute key,
            JScriptString jscript)
        {
        ...
        internal void RenderBeginTag(string tagName)
        {
            m_htmlTextWriter.RenderBeginTag(tagName);
        }

        internal void RenderBeginTag(HtmlTextWriterTag tagKey)
        {
        ...
        internal void WriteText(PlainTextString plainText)
        {
