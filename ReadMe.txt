...
build process, can be deleted by running "fmake cleanall" in a Visual Studio 2005 Command Prompt
...
source code:
  ...
  1. Run a Visual Studio 2005 Command Prompt.  Do the following steps in that command prompt.
  ...
  3. Now you're ready to install your build of the SLK application into SharePoint.
      ...
      (b) Otherwise, you can do the faster approach: in a Visual Studio 2005 Command Prompt, CD to
...
as the contents of these .zip files as follows: in a Visual Studio 2005 Command Prompt, CD to
C:\dev\SLK and run the following command:
